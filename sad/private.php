...
<div style="width: 80%;background-color: white;margin-left: 10%;margin-top: 2%;" class="bodyy">
  <button  class="accordion"><h4 style="margin-left: 5px;"><a style="text-decoration: none;color:black" href="./university/nsu.php">North South University (NSU)</a> </h4></button>
  <div class="panel">
   </div>
  <hr>
  <button  class="accordion"><h4 style="margin-left: 5px;"><a style="text-decoration: none;color:black" href="./university/uiu.php">United International University (UIU)</a> </h4></button>
  <div class="panel">
   
  </div>
  <hr>
  
  <button  class="accordion"><h4 style="margin-left: 5px;"><a style="text-decoration: none;color:black" href="./university/aust.php">Ahsanullah University of Science and Technology (AUST)</a> </h4></button>
  <div class="panel">
   
  </div>
  <hr>

  <button  class="accordion"><h4 style="margin-left: 5px;">Brac University</h4></button>
  <div class="panel">
   
  </div>
  <hr>

  <button  class="accordion"><h4 style="margin-left: 5px;">Daffodil International University (DIU)</h4></button>
  <div class="panel">
   
  </div>
  <hr>

  <button  class="accordion"><h4 style="margin-left: 5px;">Independent University, Bangladesh (IUB)</h4></button>
  <div class="panel">
